...
export function NotificationPannel() {
    ...
    return (
        ...
        onClick={() => sendNotif("" ,{toUserId:"", friendshipId: "15291648-03b4-4204-adbb-b073a945128f", title:"test",message:"this is a message", type:NotificationType.FRIEND_REQUEST})}>try</button>
            {!isVisible && (
                <>
