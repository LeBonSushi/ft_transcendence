...
import { Room } from "@travel-planner/shared";
...
export default function RoomClient({ initialRooms, usernameMap }: RoomClientProps) {
              ...
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-400 mt-2">
                    Admin: <span>{usernameMap[room.creatorId] || 'Inconnu'}</span>
                  </p>
